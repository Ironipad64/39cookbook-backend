...
public class Swagger2Config
{
    ...
    public Docket api()
    {
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors.basePackage("com.lambdaschool.cookbook"))
    ...
    {
        return new ApiInfoBuilder().title("Family Recipes Cookbook —— TT72 BW Project")
                .contact(new Contact("Chaz Kiker", "https://github.com/chazkiker2", "chazkiker@gmail.com"))
                .description("TT72 BW ——  BACKEND: Chaz Kiker —— FRONTEND: Rees Harper, Mike Galvin, Ismael Hernandez")
                .license("MIT")
